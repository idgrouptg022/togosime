                   ...
                   <div class="ml-auto text-right">
                       <nav aria-label="breadcrumb">
                           <ol class="breadcrumb">
                               ...
                               <li class="breadcrumb-item active" aria-current="page">Ajouter un site</li>
                           </ol>
                       </nav>
                   </div>
               </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    ...
                    <form action="{{ route('storeSite') }}" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" name="nom" id="nom" required class="form-control" placeholder="Saisir le nom du site ici ....">
                        <br />

                        <label for="editor1">* Description du site :</label>
